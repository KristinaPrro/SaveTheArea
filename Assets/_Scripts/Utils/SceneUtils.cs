public static class SceneUtils
{
	...
	public const float PROGRESS_VALUE_START_LOADING_NEW_SCENE = 0.3f;
	public const float PROGRESS_VALUE_START_LOADING_NEW_SCENE_REVERS = 1 - PROGRESS_VALUE_START_LOADING_NEW_SCENE;
